...
public class HomeInventory extends JFrame {
	...
	public HomeInventory() {
		...
		newButton = new JButton(new ImageIcon("imgicon/new1.png"));
		deleteButton = new JButton(new ImageIcon("delete.gif"));
		saveButton = new JButton(new ImageIcon("save.gif"));
		previousButton = new JButton(new ImageIcon("previous.gif"));
		nextButton = new JButton(new ImageIcon("next.gif"));
