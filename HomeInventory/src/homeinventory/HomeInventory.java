...
public class HomeInventory extends JFrame {
	...
	JLabel itemLabel, locationLabel, serialLabel, priceLabel, dateLabel, storeLabel, noteLabel, jphotoLabel,photoLabel;
	...
	public HomeInventory() {
		...
		newButton = new JButton(new ImageIcon("imgicon/new.png"));
		deleteButton = new JButton(new ImageIcon("imgicon/delete.png"));
		saveButton = new JButton(new ImageIcon("imgicon/save.png"));
		previousButton = new JButton(new ImageIcon("imgicon/previous.png"));
		nextButton = new JButton(new ImageIcon("imgicon/next.png"));
		printButton = new JButton(new ImageIcon("imgicon/print.png"));
	...
	private void checkSave() {
		...
		if (!myInventory[currentEntry - 1].description.equals(itemTextField.getText()))
			...
			edited = true;
		if (edited) {
			if (JOptionPane.showConfirmDialog(null, "You have edited this item. Do you want tosave the changes?",
